...
class App extends Component {
    ...
    renderButton = () => {
        ...
        return (
            <MyButton onPress={() => this.onButtonPress()} value="LOGIN" />
        );
    }
                ...
                <LinearGradient colors={['#f05d00', '#f6b436']} style={styles.up}>
                    <View style={styles.upContent}>
                        <Ionicons
                            ...
                            size={100}
                        />
                        <Text style={styles.upLogin}>Login</Text>
                    </View>
                </LinearGradient>
                <View style={styles.down}>
                    ...
                    <View style={styles.downButton}>
                        ...
                        <View style={styles.buttonText}>
                            <Text style={{ fontFamily: 'Montserrat-Light' }}> Don't have an account? </Text>

                            <TouchableOpacity onPress={() => this.props.navigation.navigate('Register')}>
                                <Text style={{ color: '#f05d00', fontFamily: 'Montserrat-Light' }}> Register</Text>
                            </TouchableOpacity>
                        </View>
